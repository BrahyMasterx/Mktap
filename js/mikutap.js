...
var MainManager = function() {
        ...
        function n(n) {
            (U = !U) ? ($("#bt_feedback a").text("Feedback: open"), aidn.util.setCookie("fb", "on", 2592e3)) : ($("#bt_feedback a").text("Feedback: close"), aidn.util.setCookie("fb", "off", 2592e3)), n && n.preventDefault()
        }

        function o(n) {
            (T = !T) ? ($("#bt_backtrack a").text("Background Music: On"), aidn.util.setCookie("bt", "on", 2592e3)) : ($("#bt_backtrack a").text("Background music: off"), aidn.util.setCookie("bt", "off", 2592e3)), n && n.preventDefault()
        }
        ...
        var G, A, y = aidn.util.checkJapanese(),
            ...
            M = "Mikutap";
        M += y ? ",Hatsune Miku 10th Anniversary" : ",Miku10th", $("#bt_tw").click(function(n) {
